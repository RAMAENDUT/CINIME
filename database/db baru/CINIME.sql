...
(4, 100, '2025-11-10 17:33:23', '2025-11-10 17:33:32');
...
(26, 1, '123', 'posters/lexOq9KPVfqsdKkWIN1qlbmrLhI7w9BANH0hS3l6.png', '123', NULL, 0.04, 'Japanese', '2025-11-02', '123', 'PG-13', '01:27:00', '2025-11-10 17:25:18', '2025-11-10 17:25:18');
...
(1, 1, 2, 50000.00, '2025-12-02', '06:46:00', '08:45:00', 24, '2024-12-26 01:08:01', '2025-11-10 18:09:49'),
(2, 2, 2, 50000.00, '2025-01-11', '06:39:00', '08:22:00', 26, '2024-12-26 01:08:01', '2024-12-26 01:08:01'),
(3, 3, 1, 50000.00, '2025-01-09', '06:08:00', '10:32:00', 19, '2024-12-26 01:08:01', '2024-12-27 02:18:22'),
(4, 4, 2, 50000.00, '2025-01-05', '07:38:00', '08:09:00', 29, '2024-12-26 01:08:01', '2024-12-26 01:08:01'),
(5, 5, 2, 50000.00, '2024-12-29', '07:04:00', '08:49:00', 28, '2024-12-26 01:08:01', '2024-12-26 01:08:02');
...
(1, 1, 69, 16, '2024-12-26 01:08:02', '2024-12-26 01:08:02'),
(2, 2, 70, 6, '2024-12-26 01:08:02', '2024-12-26 01:08:02'),
(3, 3, 71, 19, '2024-12-26 01:08:02', '2024-12-26 01:08:02'),
(4, 4, 72, 8, '2024-12-26 01:08:02', '2024-12-26 01:08:02'),
(5, 5, 89, 5, '2024-12-26 01:08:02', '2024-12-26 01:08:02'),
(6, 1, 94, 14, '2025-11-10 18:09:49', '2025-11-10 18:09:49');
SET IDENTITY_INSERT reservations OFF;
GO

ADD CONSTRAINT FK_shows_movies FOREIGN KEY (movie_id)
REFERENCES movies (id)
ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE shows
ADD CONSTRAINT FK_shows_rooms FOREIGN KEY (room_id)
REFERENCES rooms (id)
ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE reservations
ADD CONSTRAINT FK_reservations_shows FOREIGN KEY (show_id)
REFERENCES shows (id)
ON DELETE CASCADE ON UPDATE CASCADE;
